...
#define YDB_QUERY_STORAGE_INFO 9

#define YDB_STORAGE_NORMAL 0
#define YDB_STORAGE_INITING 1
#define YDB_STORAGE_DSYNCING 2
#define YDB_STORAGE_CSYNCING 3
#define YDB_STORAGE_RUNNING 4
#define YDB_STORAGE_CLOSING 5
#define YDB_STORAGE_CLOSED 6

#define YDB_STORAGE_UPLOAD 0
#define YDB_STORAGE_FIND 1
#define YDB_STORAGE_MODIFY 2
#define YDB_STORAGE_DELETE 3
#define YDB_STORAGE_SYNC_DELETE 4
#define YDB_STORAGE_SYNC_FILE 5
