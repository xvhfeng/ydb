...
#define YDB_TRACKER_REGEDIT_FROM_STORAGE 1
#define YDB_TRACKER_HEARTBEAT_FROM_STORAGE 2
#define YDB_TRACKER_SHUTDOWN_FROM_STORAGE 3
...
#define YDB_TRACKER_QUERY_SYNC_STORAGES 8
#define YDB_TRACKER_QUERY_STORAGE_STATUS 9
